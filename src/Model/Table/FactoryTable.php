 ...
 */
class FactoryTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('factory');
        $this->setDisplayField('id_factory');
        $this->setPrimaryKey('id_factory');

        $this->belongsToMany('Person', [
            'foreignKey' => 'factory_id',
            'targetForeignKey' => 'person_id',
            'joinTable' => 'person_factory'
        ]);
    }
    ...
    public function validationDefault(Validator $validator)
    {
        $validator
            ->integer('id_factory')
            ->allowEmpty('id_factory', 'create');

        $validator
            ->scalar('name_factory')
            ->allowEmpty('name_factory');
